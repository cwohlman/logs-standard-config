...
function emitRecord(rec, line, opts, stylize) {
    ...
    case OM_LONG:
        ...
        // ignore meteor version because it'll be the same for every line
        delete rec.meteorVersion;
        ...
        //     emit(format('%s: %s on %s%s:%s%s\n%s',
        //         time,
        //         level,

        //         // Ignore name because it'll be the same for every line
        //         // nameStr,
